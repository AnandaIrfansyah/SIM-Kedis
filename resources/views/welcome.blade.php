...
<body>
    ...
    <header id="home">
        <div class="header__container">
            <div class="header__content">
                <p>Scan QR Code untuk cek detail kendaraan dan status pajak.</p>
                <h1>Informasi Kendaraan Dishub Kota Cirebon</h1>
                <div class="header__btns">
                    <button class="btn">Lihat Data Kendaraan</button>
                    <a href="#">
            ...
            <div class="header__image">
                <img src="pages/img/bus.png" alt="header" />
            </div>
        </div>
    </header>
    ...
    <section class="section__container destination__container" id="about">
        ...
        <div class="destination__grid">
            <div class="destination__card">
                <img src="pages/img/card.jpg" alt="destination" />
            ...
            <div class="destination__card">
                <img src="pages/img/card2.jpg" alt="destination" />
                <div class="destination__card__details">
                    <div>
            ...
            <div class="destination__card">
                <img src="pages/img/card3.webp" alt="destination" />
                <div class="destination__card__details">
                    <div>
    ...
    <section class="section__container showcase__container" id="package">
        <div class="showcase__image">
            <img src="pages/img/showcase.webp" alt="showcase" />
        </div>
